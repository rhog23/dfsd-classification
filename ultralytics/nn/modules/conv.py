...
class SimAM(nn.Module):
    ...
    Ref: https://github.com/ZjjConan/SimAM?tab=readme-ov-file#simam-a-simple-parameter-free-attention-module-for-convolutional-neural-networks
    """
    ...
    def forward(self, x):
        # ref: https://proceedings.mlr.press/v139/yang21o.html fig.3
        _, _, h, w = x.size()
